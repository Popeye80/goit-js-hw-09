...
var daysTime = document.querySelector('[data-days]');
var hoursTime = document.querySelector('[data-hours]');
var minutesTime = document.querySelector('[data-minutes]');
var secondsTime = document.querySelector('[data-seconds]');
...
function onBtnStart(selectedDate) {
  var chooseDate = selectedDate.getTime();
...
function onBtnAfterStart(chooseDate) {
  btnStart.addEventListener('click', function () {
    ...
    var timerId = setInterval(function () {
      ...
      var restTime = convertMs(chooseDate - currentTime);
...
function getTimeComponents(_ref) {
  var days = _ref.days,
      hours = _ref.hours,
